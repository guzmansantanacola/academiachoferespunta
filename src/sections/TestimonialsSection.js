...
function TestimonialsSection() {
  ...
  return (
    <section className="testimonials-section">
      <Container>
        <h3 className="text-center mb-3" style={{ color: 'var(--primary-yellow)', fontSize: '1.2rem', fontWeight: '500' }} data-aos="fade-down">
        ...
        <h2 className="section-title text-white" data-aos="fade-up">Lo Que Dicen Nuestros Alumnos</h2>
        <Row>
          {testimonials.map((testimonial, index) => (
            <Col lg={4} md={6} className="mb-4" key={index}>
              <Card className="testimonial-card h-100" data-aos="fade-up" data-aos-delay={index * 150}>
                <Card.Body>
